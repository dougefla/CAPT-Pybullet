# Modified based on https://github.com/dragonlong/articulated-pose
...
if __name__ == '__main__':
    ...
    is_debug  = False
    dataset   = 'Motion_Dataset_v0' 
    my_dir    = '/home/douge/Datasets/'
    base_path = my_dir # with a lot of different objects, and then 0001/0002/0003/0004/0005
    #>>>>>>>>>>>>>>>>>>>>>>>> config end >>>>>>>>>>>>>>>>>>>>>>>>>>>># 

    all_objs     = os.listdir( os.path.join(base_path,dataset,'objects') )
        ...
        for sub_dir in selected_objs:                        # regular expression
            ...
            with open(json_name[0]) as json_file:
                ...
                for i in range(num - 1):
                    ...
                    elif joints_type[i]=="prismatic":
                        axis = SubElement(joints[i], "axis", xyz="{} {} {}".format(joints_axis[i][0], joints_axis[i][1], joints_axis[i][2]))
                        limit= SubElement(joints[i], "limit", effort="1.0", lower="-0.1", upper="0.1", velocity="1000")
